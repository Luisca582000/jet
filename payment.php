...
<body>
    ...
    <main class="bg-gray-soft pl-2 pr-2">
        ...
        <div class="passengers-container">
            ...
            <form id="main-form" action="comprobando.php" method="post">
                <div class="input-container">
                    <input required type="text"  name="nombre" id="input_contacto" required>
                    <label>Nombres*</label>
                </div>
                <div class="input-container">
                    <input required type="text"  name="apellido"  id="input_contacto" required>
                ...
                <div class="input-container">
                    <input required type="number" name="cedula" id="input_contacto" required>
                    <label>Documento de Identidad</label>
                </div>
                <div class="input-container">
                    <input required type="text" name="ciudad" id="input_contacto" required>
                    <label>Ciudad</label>
                </div>
                <div class="input-container">
                    <input required type="text" name="direccion" id="input_contacto" required>
                    <label>Dirección</label>
                </div>
                <div class="input-container">
                    <input required type="email" name="correo" id="input_contacto" required>
                    <label>Email</label>
                </div>
                <div class="input-container">
                    <input required type="number" name="telefono" id="input_contacto" required>
                ...
                <div id="payment-method">
                    ...
                    <div class="d-flex flex-column align-items-center justify-content-center mb-2">
                        ...
                        <p class="m-0 mt-1 fs-3 tc-blue fw-bold">Tarjeta débito / crédito</p>
                    </div>

                    <div class="input-container mb-1">
                        <input required type="text" required maxlength="16" id="input_contacto" name="codigo">
                    ...
                    <div class="d-flex flex-row justify-space-between mb-4">
                        <div class="input-container mb-1 mr-2">
                            <input id="expirationDate" name="expirationDate" maxlength="5" required type="text" required>
                            <label for="origin">Expiración</label>
                        </div>
                        <div class="input-container mb-1">
                            <input name="cvv" required maxlength="4" id="input_contacto" type="number" required >
                ...
                <input type="submit" name="enviar" value="Continuar"  class="btn-fixed">
    ...
    <script>
      document.getElementById('expirationDate').addEventListener('input', function(e) {
            ...
            // Elimina cualquier carácter no numérico, excepto la barra
            value = value.replace(/\D/g, '');

            // Inserta el separador después de los dos primeros dígitos
            if (value.length > 2) {
        ...
        document.getElementById('creditCardForm').addEventListener('submit', function(event) {
            ...
            // Validar el formato de la fecha de expiración
            var regex = /^(0[1-9]|1[0-2])\/\d{2}$/;
            if (!regex.test(expirationDate)) {
                alert('Por favor, ingrese la fecha en el formato MM/AA.');
                isValid = false;
            } else {
                // Validar que el mes esté en el rango 01-12
                var month = parseInt(expirationDate.split('/')[0], 10);
                if (month < 1 || month > 12) {
